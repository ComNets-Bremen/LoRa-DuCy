...
def get_node_id(hex=False):
    ...
    vl.log(var='node_id', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
...
vl.log(var='lora', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
s = socket.socket(socket.AF_LORA, socket.SOCK_RAW)
vl.log(var='s', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
s.setblocking(False)
pycom.heartbeat(False)
wlan = WLAN()
vl.log(var='wlan', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
wlan.deinit()
bluetooth = Bluetooth()
vl.log(var='bluetooth', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
bluetooth.deinit()
...
# if get_node_id() == 3253554266:
    my_number = 1
    vl.log(var='my_number', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
    source_address = 'Mac' + str(my_number)
    vl.log(var='source_address', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
...
vl.log(var='number_of_neighbours', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)


######### Initialize the timers #######################
chrono = Timer.Chrono()
vl.log(var='chrono', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
chrono1 = Timer.Chrono()
vl.log(var='chrono1', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
chrono2 = Timer.Chrono()
vl.log(var='chrono2', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
chrono3 = Timer.Chrono()
vl.log(var='chrono3', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)

############ Configurable Parameters #################
wakeup_interval = 20
vl.log(var='wakeup_interval', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
fast_sleep_threshold = 2.5
vl.log(var='fast_sleep_threshold', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
transmission_type = 'Unicast'  #Unicast or Broadcast
vl.log(var='transmission_type', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
num_of_packets = 10
vl.log(var='num_of_packets', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
pll_threshold = 7
vl.log(var='pll_threshold', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
cca_duration = 0.08
vl.log(var='cca_duration', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
cca_interval = 0.4
vl.log(var='cca_interval', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
rssi_threshold = 100
vl.log(var='rssi_threshold', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
packet_size = 255  # bytes
vl.log(var='packet_size', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)

############ Configuring the device ####################
packet_number = 1
vl.log(var='packet_number', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
transmissions = 0
vl.log(var='transmissions', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
alive_time = 0
vl.log(var='alive_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
phase_lock_time_saving = 0
vl.log(var='phase_lock_time_saving', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
saved_transmissions = 0
vl.log(var='saved_transmissions', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
failed_attempts = 0
vl.log(var='failed_attempts', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
phase_lock_cca_fails = 0
vl.log(var='phase_lock_cca_fails', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
Awake_instance = 1
vl.log(var='Awake_instance', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
broadcast_time_save = 0
vl.log(var='broadcast_time_save', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
fast_sleep_time_save = 0
vl.log(var='fast_sleep_time_save', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
Full_send_time = 0
vl.log(var='Full_send_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
Tx_time = 0
vl.log(var='Tx_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
Rx_time = 0
vl.log(var='Rx_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
ack = False
vl.log(var='ack', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
only_listen = False
vl.log(var='only_listen', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
noise_detected_counter = 0
vl.log(var='noise_detected_counter', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
ack_data_packets = []
vl.log(var='ack_data_packets', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
cca_list = []
vl.log(var='cca_list', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
received_time = []
vl.log(var='received_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
received_full_data = []
vl.log(var='received_full_data', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
phase_lock_optimization = {}
vl.log(var='phase_lock_optimization', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
phase_lock_optimization_time = {}
vl.log(var='phase_lock_optimization_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
max_wait_time = 1 * wakeup_interval
vl.log(var='max_wait_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
lora_off_time = 0.6
vl.log(var='lora_off_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
packet_gap_interval = 0.9
vl.log(var='packet_gap_interval', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
pll_activation = 2.0
vl.log(var='pll_activation', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
sleep_in_pll = 3
vl.log(var='sleep_in_pll', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
transmission_in_pll = 2.9
vl.log(var='transmission_in_pll', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)

############## Delay to avoid CCA overlap ############
# number2 = (wakeup_interval - 2) / 10
# vl.log(var='number2', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
...
def Random():
    ...
    vl.log(var='r', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
...
def RandomRange(rfrom, rto):
    ...
    vl.log(var='0', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
...
def packet_check(packet_status, s=Awake_instance, g=packet_number):
    ...
    if not packet_status:
        ...
        vl.log(var='number', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
...
def cca(x=packet_gap_interval, f=lora_off_time, c=cca_list, d=chrono, l=lora, h=cca_duration, m=rssi_threshold, n=cca_interval):
    ...
    while chrono1.read() < cca_duration:
        ...
        vl.log(var='c', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
    cca_pin(False)
    chrono1.stop()
    chrono1.reset()
    chrono.stop()
    ...
    if 'False' in cca_list:
        ...
        while chrono1.read() < cca_interval:
            ...
            vl.log(var='l', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
...
vl.log(var='neighbour_discover', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
neighbor_adresses = []
vl.log(var='neighbor_adresses', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
while not neighbour_discover:
    ...
    vl.log(var='number', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
    if number != my_number:
        neighbor = 'Mac' + str(number)
        vl.log(var='neighbor', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
...
vl.log(var='Broadcast_address', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
neighbor = 0
vl.log(var='neighbor', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
...
packet_status = False
vl.log(var='packet_status', fun=_fun_name, clas=_cls_name, th=_thread_id, save=True, detection=True)
...
while True:
    try:
        ...
        vl.log(var='channel_status', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
        packet_status = packet_check(packet_status, Awake_instance, packet_number)
        vl.log(var='packet_status', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
        lora = LoRa(power_mode=LoRa.ALWAYS_ON, region=LoRa.EU868)
        vl.log(var='lora', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
        ...
        while len(s.recv(packet_size)) > 0:
            ...
            lora_rx(False)
            vl.log(var='ss', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            events = lora.events()
            vl.log(var='events', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
        ...
        if channel_status and packet_status and not only_listen:
            ...
            print('Sending Data')
            send_time = 0
            vl.log(var='send_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            data = ' Data '
            vl.log(var='data', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            cca_time = chrono.read()
            vl.log(var='cca_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            cca_list.clear()
            vl.log(var='cca_list', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)


            if transmission_type == 'Unicast':
                ########### Unicast Transmission ##########################
                send_time_updated = False
                vl.log(var='send_time_updated', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                if ack:
                    neighbor += 1
                    vl.log(var='neighbor', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                if neighbor >= len(neighbor_adresses):
                    neighbor = 0
                    vl.log(var='neighbor', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)

                destination_address = neighbor_adresses[neighbor]
                vl.log(var='destination_address', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                safe_time = packet_gap_interval + 0.2
                vl.log(var='safe_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                channel_checked = True
                vl.log(var='channel_checked', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                ack = False
                vl.log(var='ack', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                Phase_Lock_channel_check = False
                vl.log(var='Phase_Lock_channel_check', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                phase_lock_transmissions = 0
                vl.log(var='phase_lock_transmissions', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    ...
                    while not ack and chrono.read() < max_wait_time:
                        if float(phase_lock_optimization_time.get(destination_address)) - transmission_in_pll <= chrono.read() and phase_lock_transmissions < pll_threshold:
                            ...
                            if channel_checked:
                                ...
                                vl.log(var='phase_lock_time_saving', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                ...
                                if cca():
                                    ...
                                    vl.log(var='packet1', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                    padding = packet_size - len(packet1)
                                    vl.log(var='padding', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False) 
                                    zero_padding = '0' * padding
                                    vl.log(var='zero_padding', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                    packet = packet1 + zero_padding
                                    vl.log(var='packet', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                    ...
                                    lora_tx(False)
                                    transmissions += 1
                                    vl.log(var='transmissions', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                    ...
                                    vl.log(var='phase_lock_cca_fails', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                            ...
                            vl.log(var='phase_lock_optimization', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                            # print(phase_lock_optimization)
                            phase_lock_optimization_time.pop(destination_address)
                            vl.log(var='phase_lock_optimization_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                            # print(phase_lock_optimization_time)
                            break
                        else:
                            saved_transmissions += 1
                            vl.log(var='saved_transmissions', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                            
                        if not send_time_updated and chrono.read() > wakeup_interval - safe_time:
                            send_time_updated = True
                            vl.log(var='send_time_updated', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                            Full_send_time = send_time - 1
                            vl.log(var='Full_send_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                        ...
                        try:
                            ...
                            print('rx 2')
                            rcv_packet1 = s.recv(packet_size)
                            vl.log(var='rcv_packet1', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                            lora_rx(False)
                            s.settimeout(0)
                        except TimeoutError:
                            s.settimeout(0)
                        ...
                        vl.log(var='decode_packet', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                        if len(decode_packet) >= 5:
                            if decode_packet[3] == str(packet_number) and decode_packet[1] == source_address:
                                if send_time_updated:
                                    ...
                                    vl.log(var='period', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                ...
                                vl.log(var='ack_data_packets', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                # print(len(ack_data_packets))
                                packet_number += 1
                                vl.log(var='packet_number', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                                ack = True
                                vl.log(var='ack', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                        send_time += 1
                        vl.log(var='send_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                ...
                if chrono.read() >= max_wait_time:
                    ...
                    # vl.log(var='neighbor_adresses', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    print(neighbor_adresses)

                if len(neighbor_adresses) == 0:
                    ########### If there are no neighbours only perform packet reception ##########################
                    only_listen = True
                    vl.log(var='only_listen', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)

                if not ack and destination_address != Broadcast_address and not Phase_Lock_channel_check:
                    ########### Identify transmission failures ##########################
                    failed_attempts += 1
                    vl.log(var='failed_attempts', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)              

                alive_time += chrono.read()
                vl.log(var='alive_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                ...
                while chrono.read() < time_left:
                    lora = LoRa(power_mode=LoRa.SLEEP, region=LoRa.EU868)
                    vl.log(var='lora', fun=_fun_name, clas=_cls_name, th=_thread.get_ident(), save=False, detection=False)
                ...
                if chrono3.read() > wakeup_interval:
                    ...
                    vl.log(var='insatnce', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    Awake_instance += insatnce
                    vl.log(var='Awake_instance', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                else:
                    Awake_instance += 1
                    vl.log(var='Awake_instance', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                chrono3.stop()
                ...
                while chrono.read() < wakeup_interval - safe_time:
                    ...
                    vl.log(var='broadcast_time_save', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    send_time += 1
                    vl.log(var='send_time', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                ...
                vl.log(var='time_left', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                chrono.stop()
                chrono.reset()
                chrono.start()
                while chrono.read() < time_left:
            ...
            noise_found = True
            vl.log(var='noise_found', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            print('Receiving Data')
            time_now = chrono3.read()
            vl.log(var='time_now', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            ...
            while chrono3.read() < (packet_gap_interval * 1.1 + time_now):
                ...
                if cca_list.count('True') <= 10 and chrono3.read() > (packet_gap_interval + time_now):
                    ...
                    vl.log(var='noise_detected_counter', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    break
            lora = LoRa(power_mode=LoRa.ALWAYS_ON, region=LoRa.EU868)
            vl.log(var='lora', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            cca_list.clear()
            vl.log(var='cca_list', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            event = 0
            vl.log(var='event', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            while event != 1 and noise_found:
                ...
                if chrono3.read() >= fast_sleep_threshold:
                    ...
                    vl.log(var='fast_sleep_time_save', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    break
            ...
            # lora_rx(False)
            # vl.log(var='rcv_packet', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
            ...
            if len(decode_packet) >= 6:
                ...
                vl.log(var='receiving_data', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)

                if decode_packet[1] == source_address:
                    ########### Unicast packet reception ##########################
                    received_full_data.append(receiving_data)
                    vl.log(var='received_full_data', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
                    ...
                    vl.log(var='ack_packet', fun=_fun_name, clas=_cls_name, th=_thread_id, save=False, detection=False)
